...
export class Contract__getRentalResultValue0Struct extends ethereum.Tuple {
  get lessor(): Address {
...
export class Contract extends ethereum.SmartContract {
  ...
  getRental(
    _contractAddress: Address,
    _tokenId: BigInt
  ): Contract__getRentalResultValue0Struct {
    let result = super.call(
      "getRental",
    ...
    return changetype<Contract__getRentalResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getRental(
    _contractAddress: Address,
    _tokenId: BigInt
  ): ethereum.CallResult<Contract__getRentalResultValue0Struct> {
    let result = super.tryCall(
      "getRental",
      "getRental(address,uint256):((address,address,uint256))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<Contract__getRentalResultValue0Struct>(value[0].toTuple())
    );
  }
...
export class SetManyLandUpdateOperatorCall extends ethereum.Call {
  get inputs(): SetManyLandUpdateOperatorCall__Inputs {
    return new SetManyLandUpdateOperatorCall__Inputs(this);
  }

  get outputs(): SetManyLandUpdateOperatorCall__Outputs {
    return new SetManyLandUpdateOperatorCall__Outputs(this);
  }
}

export class SetManyLandUpdateOperatorCall__Inputs {
  _call: SetManyLandUpdateOperatorCall;

  constructor(call: SetManyLandUpdateOperatorCall) {
    this._call = call;
  }
  ...
  get _landTokenIds(): Array<Array<BigInt>> {
...
export class SetManyLandUpdateOperatorCall__Outputs {
  _call: SetManyLandUpdateOperatorCall;
